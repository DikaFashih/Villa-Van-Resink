...
const fitur = [
  { title: "Kapasitas Hingga 300 Tamu", desc: "Halaman belakang villa cukup luas untuk resepsi standing maupun kursi tertata.", icon: Users },
  { title: "Taman & Dekorasi Alami", desc: "Latar taman botani dan fasad kolonial jadi dekorasi alami tanpa perlu banyak setting tambahan.", icon: Flower2 },
  { title: "Koordinasi Acara Penuh", desc: "Tim kami membantu dari perizinan lokasi hingga koordinasi hari-H bersama vendor Anda.", icon: ClipboardCheck },
  { title: "Katering & Venue Makan", desc: "Area kantin dan pendopo tersedia untuk kebutuhan katering tamu undangan.", icon: Utensils },
];
    ...
    <section className="bg-[#E1E100] py-20 sm:py-28 lg:py-32 text-[#23412D]">
      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-2 lg:items-center lg:gap-20">
        ...
        >
          ...
          <p className="text-xs uppercase tracking-[0.35em] text-[#23412D]/70">Momen Sekali Seumur Hidup</p>
          <h2 className="mt-4 font-heading text-4xl leading-tight sm:text-5xl">Wedding Venue</h2>
              ...
              return (
                ...
                <div key={item.title} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-[#23412D]/70">{item.desc}</p>
                  </div>
