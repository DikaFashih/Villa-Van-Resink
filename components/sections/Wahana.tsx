...
const wahana = [
  {
    ...
    image: "/images/wahana/camping ground.webp",
    tall: false,
  },
  {
    slug: "flying-fox",
    ...
    image: "/images/wahana/Flying Fox.webp",
    tall: true,
  },
  {
    slug: "green-house",
    ...
    image: "/images/wahana/greenhouse1.webp",
    tall: false,
  },
  {
    slug: "tamiya-mountain-coaster",
    title: "Tamiya Mountain Coaster",
    category: "Adrenalin",
    desc: "Nikmati Sensasi Meluncur Dikelilingi Pohon Rindang.",
    image: "/images/wahana/tamiyamontaincoaster.png",
    tall: false,
  },
  {
    slug: "panahan",
    ...
    image: "/images/wahana/panahan1.webp",
    tall: true,
  },
];
        ...
        <div className="mt-14 grid gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-3">
          {wahana.map((item, index) => (
            ...
            >
              ...
              <div
                className={`relative overflow-hidden rounded-[6px] ${item.tall ? "h-[380px]" : "h-[280px]"}`}
              >
                <Image
                  src={item.image}
                  alt={item.title}
              ...
              <p className="mt-5 text-[11px] uppercase tracking-[0.3em] text-[#8A6E4A]">
                {item.category}
              </p>
              <h3 className="mt-2 font-heading text-2xl text-[#23412D]">
                {item.title}
              </h3>
              ...
              {/* PERBAIKAN: Gunakan index + 1 agar ID-nya unik sesuai urutan, dan tambahkan requireBooking={false} */}
              <ReviewBox
